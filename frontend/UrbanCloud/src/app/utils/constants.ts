export default class ConstantValues {
  ...
  static importantInfo: string[] = [
    ...
    'Politiska protokoll och beslut',
    'Processtöd',
    'Yttranden',
    'Projektmodeller',
  ];
  ...
  static dummyAreas: any[] = [
    {
      ...
      includes: [
        ...
        'Dagvatten',
        'Dräneringsvatten',
        'Drift underhåll och förnyelse av...',
    ...
    },
    {
      ...
      includes: [
        ...
        'Dräneringsvatten',
        'Drif underhåll och förnyelse av...',
        'Hållbar nyanläggning',
        'Miljöbalken',
      ],
    },
    {
      ...
      includes: [
        ...
        'ESTER',
        'Dräneringsvatten',
        'Drift underhåll och förneylse av...',
        'Hållbar nyanläggning',
        'Miljöbalken',
      ],
    },
